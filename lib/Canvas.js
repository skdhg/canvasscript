const { DrawContext } = require("./binding");
...
class Canvas {
    ...
    constructor(width, height) {
        this.#context = new DrawContext(width, height);
    }
    ...
    getContext(ctx) {
        ...
        return new CanvasRenderingContext2D(this, this.#context);
    }
    ...
    toBuffer(format = "image/png", options = {}) {
        ...
        switch (format) {
            ...
            case "image/bmp": {
                ...
                const rawBuffer = Buffer.from(this.#context.getBuffer());
